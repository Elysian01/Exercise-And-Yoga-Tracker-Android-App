...
public class ClassifyYogaSet1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classify_yoga);
        ...
        try{
            tflite=new Interpreter(loadmodelfile(ClassifyYogaSet1Activity.this));
        }catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private MappedByteBuffer loadmodelfile(Activity activity) throws IOException {
        AssetFileDescriptor fileDescriptor=activity.getAssets().openFd("set1_model.tflite");
...
//To set components of x axis
    ...
    private void showresult(){
        ...
        try{
            labels = FileUtil.loadLabels(ClassifyYogaSet1Activity.this, "set1_labels.txt");
        }catch (Exception e){
            e.printStackTrace();
        }
        ...
        for (Map.Entry<String, Float> entry : labeledProbability.entrySet()) {
            ...
            prediction.setText("Yoga Set 1 Pose Prediction:");
