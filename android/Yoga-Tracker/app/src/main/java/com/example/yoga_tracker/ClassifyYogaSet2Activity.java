...
public class ClassifyYogaSet2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            tflite=new Interpreter(loadmodelfile(ClassifyYogaSet2Activity.this));
        }catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private MappedByteBuffer loadmodelfile(Activity activity) throws IOException {
        AssetFileDescriptor fileDescriptor=activity.getAssets().openFd("set2_model.tflite");
...
//To set components of x axis
    ...
    private void showresult(){
        ...
        try{
            labels = FileUtil.loadLabels(ClassifyYogaSet2Activity.this, "set2_labels.txt");
        }catch (Exception e){
            e.printStackTrace();
        }
        ...
        for (Map.Entry<String, Float> entry : labeledProbability.entrySet()) {
            ...
            prediction.setText("Yoga Set 2 Pose Prediction:");
